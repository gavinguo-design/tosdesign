...
- progress: "title" + "value" + optional "unit" + "subtitle" + "chartColor" default "rgba(255,95,15,1)" + "chartRatio" (filled fraction of the track, e.g. "0.42") + "chartProgressLabel" (small 10px text above the track — HARD LIMIT one short metric ≤12 chars like "42% used", NEVER append top-app breakdowns or extra ·-separated segments; put any breakdown in "subtitle" instead, it will be truncated with ellipsis anyway); bg EXACTLY "linear-gradient(180deg, rgba(255,95,15,0) 0%, rgba(255,95,15,0.10) 100%), #ffffff"
