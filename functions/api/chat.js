...
- Flight: layout=big, bg=linear-gradient(180deg,rgba(0,97,249,0.1) 0%,rgba(10,105,254,0) 100%), dark=false, header=RY9108 Departs, value=11:50, unit=AM, subtitle=SZX → PEK · Oct 10
- Train: layout=big, bg=linear-gradient(180deg,rgba(0,97,249,0.1) 0%,rgba(10,105,254,0) 100%), dark=false, header=Trn 12904, value=06:16, unit=AM, subtitle=KRMI → NDLS · Oct 10
